...
function changePosition() {
    ...
    let maxRight = wrapper.clientHeight - div.clientHeight;

    let newLeft = Math.random() * maxLeft
    let newTop = Math.random() * maxRight
    ...
    if (div.clientWidth >= (wrapper.clientWidth - 40) ||
     div.clientHeight >= (wrapper.clientHeight - 40)) {
